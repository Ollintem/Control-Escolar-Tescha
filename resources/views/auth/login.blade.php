    ...
    <main class="w-full max-w-5xl overflow-hidden rounded-[2rem] bg-white shadow-2xl shadow-[#5a142c]/15 lg:grid lg:grid-cols-[.9fr_1.1fr]">
        ...
        <section class="relative overflow-hidden bg-gradient-to-br from-[#4d1028] via-[#691632] to-[#8b2448] px-8 py-10 text-white sm:px-12 lg:flex lg:min-h-[650px] lg:flex-col lg:justify-between">
            ...
            <div class="relative">
                <div class="flex items-center gap-3">
                    ...
                    <div class="border-l border-white/20 pl-3">
                        <p class="text-xs font-semibold uppercase tracking-[0.22em] text-[#f1d18b]">TESCHA</p>
            ...
            <div class="relative border-t border-white/15 pt-5">
                <p class="text-xs font-medium uppercase tracking-[0.12em] text-white/50">Educación superior tecnológica</p>
        ...
        <section class="px-7 py-10 sm:px-12 lg:flex lg:min-h-[650px] lg:flex-col lg:justify-center">
            <div class="mx-auto w-full max-w-md">
                <div class="mb-8">
                    <p class="text-xs font-bold uppercase tracking-[0.18em] text-[#8b2448]">Bienvenido</p>
                    <h2 class="mt-2 text-3xl font-bold tracking-tight text-[#33101d]">Inicia sesión</h2>
                    <p class="mt-2 text-sm leading-6 text-slate-500">Ingresa tus credenciales para continuar al sistema.</p>
                </div>
                ...
                <form wire:submit="login" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <svg class="pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-[#8b2448]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                                <path d="M4 4h16v16H4z"/><path d="m4 7 8 5 8-5"/>
                            </svg>
                            <input wire:model="form.email" id="email" type="email" required autofocus autocomplete="username" placeholder="usuario@tescha.edu.mx"
                    ...
                    <div>
                        <div class="mb-2 flex items-center justify-between gap-4">
                            <label for="password" class="block text-xs font-bold uppercase tracking-wider text-slate-700">Contraseña</label>
                    ...
                    <label for="remember" class="flex cursor-pointer items-center gap-2.5 pt-1 text-sm text-slate-600">
                        <input wire:model="form.remember" id="remember" type="checkbox" class="h-4 w-4 rounded border-slate-300 text-[#8b2448] focus:ring-[#8b2448]">
                        Recordar mi cuenta
                    </label>
